...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"white","layout":{"inherit":true}} -->
				...
				<h2 class="has-text-align-center" id="pricing-options">Pricing Options</h2>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"align":"center"} -->
				<p class="has-text-align-center">Create a four-column table, full-width (1200px).</p>
				<!-- /wp:paragraph -->
				...
				<div class="wp-block-column"><!-- wp:group {"style":{"border":{"width":"1px","style":"solid"}},"borderColor":"black","className":"has-black-border"} -->
				<div class="wp-block-group has-black-border has-border-color has-black-border-color" style="border-style:solid;border-width:1px"><!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"bottom":"0px"}}},"backgroundColor":"black","textColor":"white","fontSize":"normal"} -->
				<h2 class="has-text-align-center has-white-color has-black-background-color has-text-color has-background has-normal-font-size" id="enterprise-495" style="margin-bottom:0px">Enterprise - $495</h2>
				<!-- /wp:heading -->
				...
				<div class="wp-block-column"><!-- wp:group {"style":{"border":{"width":"1px","style":"solid"}},"borderColor":"black","className":"has-black-border"} -->
				<div class="wp-block-group has-black-border has-border-color has-black-border-color" style="border-style:solid;border-width:1px"><!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"bottom":"0px"}}},"backgroundColor":"black","textColor":"white","fontSize":"normal"} -->
				<h2 class="has-text-align-center has-white-color has-black-background-color has-text-color has-background has-normal-font-size" id="ultimate-995" style="margin-bottom:0px">Ultimate - $995</h2>
				<!-- /wp:heading -->
