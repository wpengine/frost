...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"black","layout":{"wideSize":"800px"}} -->
				...
				<p class="has-text-align-center has-white-color has-text-color">Create a two-column table, wide-width (800px).</p>
				<!-- /wp:paragraph -->
				...
				<div class="wp-block-group" style="border-width:1px;padding-top:30px;padding-right:40px;padding-bottom:40px;padding-left:40px"><!-- wp:list {"textColor":"white","className":"pricing-table","fontSize":"small"} -->
