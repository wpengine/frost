...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"black","layout":{"inherit":true}} -->
				...
				<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:60%"><!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}},"textColor":"white","className":"has-no-bottom-margin","fontSize":"medium"} -->
				<p class="has-no-bottom-margin has-white-color has-text-color has-medium-font-size" style="line-height:1.5"><meta charset="utf-8">Lorem ipsum dolor sit amet, consectetur adipiscing lectus. Vestibulum mi justo, luctus eu pellentesque vitae gravida non.</p>
				<!-- /wp:paragraph --></div>
				<!-- /wp:column -->
				...
				<div class="wp-block-button large is-style-fill-white"><a class="wp-block-button__link no-border-radius">Get Started <meta charset="utf-8">→</a></div>
				<!-- /wp:button -->
