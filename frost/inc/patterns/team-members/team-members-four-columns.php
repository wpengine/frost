...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"white","layout":{"inherit":true}} -->
				...
				<h2 class="has-text-align-center" id="our-team">Our Team</h2>
				<!-- /wp:heading -->
				...
				<div class="wp-block-column"><!-- wp:image {"id":735,"sizeSlug":"full","linkDestination":"none"} -->
				...
				<p class="has-text-align-center has-small-font-size">Lorem ipsum dolor sit amet, consectetur et adipiscing.</p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph {"align":"center","fontSize":"small"} -->
				<p class="has-text-align-center has-small-font-size"><a href="#">View profile</a>.</p>
				<!-- /wp:paragraph --></div>
				<!-- /wp:column -->
