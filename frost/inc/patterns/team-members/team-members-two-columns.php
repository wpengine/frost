...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"white","layout":{"inherit":true}} -->
				...
				<div class="wp-block-column" style="flex-basis:22%"><!-- wp:image {"id":735,"sizeSlug":"full","linkDestination":"none"} -->
				<figure class="wp-block-image size-full"><img src="https://frostwp.com/pro/wp-content/uploads/sites/14/2021/05/sample-black_800x800.jpg" alt="Sample Frost Image" class="wp-image-735"/></figure>
				<!-- /wp:image --></div>
				<!-- /wp:column -->
				...
				<p class="has-small-font-size">Lorem ipsum dolor sit amet, consectetur adipiscing lectus. Vestibulum mi justo, luctus eu pellentesque vitae gravida non et aliquam volutpat. <a href="#">Read more</a>.</p>
				<!-- /wp:paragraph --></div>
				<!-- /wp:column --></div>
				<!-- /wp:columns -->
				...
				<!-- wp:paragraph {"fontSize":"small"} -->
				<p class="has-small-font-size">Lorem ipsum dolor sit amet, consectetur adipiscing lectus. Vestibulum mi justo, luctus eu pellentesque vitae gravida non et aliquam volutpat. <a href="https://frostwp.com/demo/wp-admin/post.php?post=1284&amp;action=edit#">Read more</a>.</p>
				<!-- /wp:paragraph --></div>
				<!-- /wp:column --></div>
				<!-- /wp:columns -->
