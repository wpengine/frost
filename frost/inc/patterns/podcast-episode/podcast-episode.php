...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","layout":{"inherit":true}} -->
				...
				<figure class="wp-block-image size-full is-style-no-margin"><img src="https://frostwp.com/wp-content/uploads/2021/12/sample-black_800x800.jpg" alt="' . esc_attr__( 'Sample Image', 'frost' ) . '" class="wp-image-3489"/></figure>
				<!-- /wp:image --></div>
				<!-- /wp:column -->
