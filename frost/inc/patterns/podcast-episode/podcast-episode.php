...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"white","layout":{"inherit":true}} -->
				...
				<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%"><!-- wp:image {"id":735,"sizeSlug":"full","linkDestination":"none","className":"is-style-no-margin"} -->
				<figure class="wp-block-image size-full is-style-no-margin"><img src="https://frostwp.com/demo/wp-content/uploads/sites/14/2021/05/sample-black_800x800.jpg" alt="Sample Frost Image" class="wp-image-735"/></figure>
				<!-- /wp:image --></div>
				<!-- /wp:column -->
