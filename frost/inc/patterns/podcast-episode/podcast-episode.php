...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"white","layout":{"inherit":true}} -->
				...
				<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%"><!-- wp:image {"id":735,"sizeSlug":"full","linkDestination":"none","className":"has-no-bottom-margin"} -->
				<figure class="wp-block-image size-full has-no-bottom-margin"><img src="https://frostwp.com/pro/wp-content/uploads/sites/14/2021/05/sample-black_800x800.jpg" alt="Sample Frost Image" class="wp-image-735"/></figure>
				<!-- /wp:image --></div>
				<!-- /wp:column -->
				
				<!-- wp:column {"verticalAlignment":"center","width":"70%"} -->
				<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:70%"><!-- wp:heading -->
				<h2 id="sample-podcast-episode">Sample Podcast Episode</h2>
				<!-- /wp:heading -->
