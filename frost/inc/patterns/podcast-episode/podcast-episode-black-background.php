...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"black","textColor":"white","layout":{"inherit":true}} -->
				...
				<figure class="wp-block-image size-full is-style-no-margin"><img src="https://frostwp.com/wp-content/uploads/2021/12/sample-white_800x800.jpg" alt="' . esc_attr__( 'Sample Image', 'frost' ) . '" class="wp-image-3488"/></figure>
				<!-- /wp:image --></div>
				<!-- /wp:column -->
