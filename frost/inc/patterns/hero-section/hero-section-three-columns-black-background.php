...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"black","textColor":"white","layout":{"inherit":true}} -->
				...
				<figure class="wp-block-image size-full"><img src="https://frostwp.com/demo/wp-content/uploads/sites/2/2021/05/sample-white_1200x1200.jpg" alt="' . esc_attr__( 'Sample Image', 'frost' ) . '" class="wp-image-242"/></figure>
				<!-- /wp:image -->

				<!-- wp:heading {"textAlign":"center","level":3} -->
				<h3 class="has-text-align-center" id="sample-heading">' . esc_html__( 'Sample Heading', 'frost' ) . '</h3>
				<!-- /wp:heading -->
