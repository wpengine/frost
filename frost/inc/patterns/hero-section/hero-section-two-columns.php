...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"white","layout":{"inherit":true}} -->
				...
				<h2 id="text-on-left-image-on-right">Text on left, image on right.</h2>
				<!-- /wp:heading -->
				...
				<figure class="wp-block-image size-full"><img src="https://frostwp.com/pro/wp-content/uploads/sites/14/2021/05/sample-black_1200x1200.jpg" alt="Sample Frost Image" class="wp-image-244"/></figure>
				<!-- /wp:image --></div>
				<!-- /wp:column --></div>
				<!-- /wp:columns -->
