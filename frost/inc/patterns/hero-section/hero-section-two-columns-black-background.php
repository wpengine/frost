...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"black","layout":{"inherit":true}} -->
				...
				<h2 class="has-white-color has-text-color" id="text-on-left-image-on-right">Text on left, image on right.</h2>
				<!-- /wp:heading -->
				...
				<figure class="wp-block-image size-full"><img src="https://frostwp.com/pro/wp-content/uploads/sites/14/2021/05/sample-white_1200x1200.jpg" alt="Sample Frost Image" class="wp-image-242"/></figure>
				<!-- /wp:image --></div>
				<!-- /wp:column --></div>
				<!-- /wp:columns -->
