...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"black","layout":{"inherit":true}} -->
				...
				<div class="wp-block-column is-vertically-aligned-center has-no-bottom-margin"><!-- wp:heading {"textColor":"white"} -->
				<h2 class="has-white-color has-text-color" id="sample-heading">Sample Heading</h2>
				<!-- /wp:heading -->
				...
				<figure class="wp-block-image size-large"><img src="https://frostwp.com/pro/wp-content/uploads/sites/14/2021/08/portfolio-white_800x800_1.jpg" alt="Sample Frost Image" class="wp-image-2433"/></figure>
				<!-- /wp:image -->
				
				<!-- wp:image {"id":2434,"sizeSlug":"large","linkDestination":"none"} -->
				<figure class="wp-block-image size-large"><img src="https://frostwp.com/pro/wp-content/uploads/sites/14/2021/08/portfolio-white_800x800_2.jpg" alt="Sample Frost Image" class="wp-image-2434"/></figure>
				<!-- /wp:image -->
				
				<!-- wp:image {"id":2435,"sizeSlug":"large","linkDestination":"none"} -->
				<figure class="wp-block-image size-large"><img src="https://frostwp.com/pro/wp-content/uploads/sites/14/2021/08/portfolio-white_800x800_3.jpg" alt="Sample Frost Image" class="wp-image-2435"/></figure>
				<!-- /wp:image -->
				
				<!-- wp:image {"id":2436,"sizeSlug":"large","linkDestination":"none"} -->
				<figure class="wp-block-image size-large"><img src="https://frostwp.com/pro/wp-content/uploads/sites/14/2021/08/portfolio-white_800x800_4.jpg" alt="Sample Frost Image" class="wp-image-2436"/></figure>
				<!-- /wp:image --></figure>
				<!-- /wp:gallery --></div>
				<!-- /wp:column --></div>
				<!-- /wp:columns -->
