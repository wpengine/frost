...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","layout":{"wideSize":"800px"}} -->
				...
				<figure class="wp-block-image size-full"><img src="https://frostwp.com/wp-content/uploads/2021/12/sample-black_1920x1200.jpg" alt="' . esc_attr__( 'Sample Image', 'frost' ) . '" class="wp-image-3480"/></figure>
				<!-- /wp:image -->
				...
				<figure class="wp-block-image size-full"><img src="https://frostwp.com/demo/wp-content/uploads/sites/2/2021/05/sample-black_1200x1200.jpg" alt="' . esc_attr__( 'Sample Image', 'frost' ) . '" class="wp-image-676"/></figure>
				<!-- /wp:image -->
