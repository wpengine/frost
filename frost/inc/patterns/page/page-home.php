...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","backgroundColor":"white","layout":{"wideSize":"800px"}} -->
				...
				<div class="wp-block-button is-style-fill-white"><a class="wp-block-button__link">Get Started</a></div>
				<!-- /wp:button -->
				
				<!-- wp:button {"className":"is-style-outline-white"} -->
				<div class="wp-block-button is-style-outline-white"><a class="wp-block-button__link">Learn More</a></div>
				<!-- /wp:button --></div>
				<!-- /wp:buttons --></div></div>
				<!-- /wp:media-text -->
				...
				<figure class="wp-block-image size-full"><img src="https://frostwp.com/demo/wp-content/uploads/sites/2/2021/05/sample-black_1200x1200.jpg" alt="Sample Frost Image" class="wp-image-676"/></figure>
				<!-- /wp:image -->
