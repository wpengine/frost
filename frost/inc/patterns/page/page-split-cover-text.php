...
return array(
	...
	'content'    => '<!-- wp:columns {"align":"full","style":{"spacing":{"margin":{"bottom":"0px"}}}} -->
				<div class="wp-block-columns alignfull" style="margin-bottom:0px"><!-- wp:column {"width":"50%","className":"is-style-no-margin"} -->
				...
				<h2 class="has-x-large-font-size" id="text-on-left-image-on-right">Cover on left, text on right.</h2>
				<!-- /wp:heading -->
