...
Download the latest stable release: [frost-0.9.3.zip](https://github.com/wpengine/frost/releases/download/v0.9.3/frost-0.9.3.zip)
...
2. Ensure you are using WordPress 5.9+ with the [Gutenberg plugin](https://wordpress.org/plugins/gutenberg/) active.
