...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/patterns/images/sample-white_1920x1200.jpg'; ?>" alt="Sample Image" class="wp-image-3482"/></figure>
<!-- /wp:image -->
