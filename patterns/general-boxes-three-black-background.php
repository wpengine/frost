 ...
 * Slug: frost/general-boxes-three-black-background
...
<div class="wp-block-column has-white-background-color has-background" style="padding-top:40px;padding-right:40px;padding-bottom:40px;padding-left:40px">
<!-- wp:heading {"level":3} -->
