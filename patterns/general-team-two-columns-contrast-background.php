...
<p style="margin-bottom:var(--wp--preset--spacing--medium)"><?php echo esc_html__( 'The people who are ready to serve you.', 'frost' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/patterns/images/sample-white_800x800.jpg'; ?>" alt="Sample Image" class="wp-image-3488"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
<!-- wp:column {"width":"75%"} -->
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Lorem ipsum dolor sit amet, consectet adipiscing lectus. Vestibulum mi justo, luctus. <a href="#"><?php echo esc_html__( 'View profile', 'frost' ); ?></a>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
<!-- wp:columns -->
