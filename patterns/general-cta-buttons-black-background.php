 ...
 * Slug: frost/general-cta-buttons-black-background
...
<!-- wp:button {"style":{"border":{"radius":0}},"className":"large is-style-fill-white"} -->
<div class="wp-block-button large is-style-fill-white"><a class="wp-block-button__link no-border-radius"><?php echo esc_html__( 'Get Started', 'frost' ); ?> →</a></div>
<!-- /wp:button -->
<!-- wp:button {"style":{"border":{"radius":0}},"className":"large is-style-outline-white"} -->
<div class="wp-block-button large is-style-outline-white"><a class="wp-block-button__link no-border-radius"><?php echo esc_html__( 'Learn More', 'frost' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
