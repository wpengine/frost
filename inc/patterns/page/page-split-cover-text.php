<?php
/**
 * Frost: Split page with cover, text
 *
 * @package Frost
 */
...
return array(
	...
	'content'    => '<!-- wp:columns {"align":"full","style":{"spacing":{"margin":{"bottom":"0px","top":"0px"},"blockGap":"0px"}}} -->
				<div class="wp-block-columns alignfull" style="margin-top:0px;margin-bottom:0px"><!-- wp:column {"width":"50%","className":"is-style-no-margin"} -->
